...
def train(cfg):
    ...
    train_loader_kwargs = {
        ...
        'video_lmdb': cfg.dataset.video_lmdb,
        'drop_last':  True,
        'pin_memory': True,
        'shuffle': True
    }
    ...
    # logging.info(model)
    # print(model.swin_model.backbone.patch_embed.proj.weight[0,0,0,0])
    model.load_swim_ckpt('swim/checkpoints/swin_base_patch244_window1677_sthv2.pth')
    ...
    # print(model.module.swin_model.backbone.patch_embed.proj.weight[0,0,0,0])
    # exit()
...
def main():
    ...
    parser.add_argument('--cfg', dest='cfg_file', help='optional config file', default='configs/msrvtt_qa.yml', type=str)
